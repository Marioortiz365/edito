                ...
                <div class="card-body">
                    <form action="<?php echo e(url('titulos/'.$row->id)); ?>" method="POST">
                        ...
                        <div class="row"> <!--inicia segundo row-->
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                ...
                                <option value="<?php echo e($ne->id); ?>" <?php if($ne->id == $row->id_editorial): ?> selected <?php endif; ?> > <?php echo e($ne->nombre); ?></option readonly>
                        ...
                        <div class="row"> <!--inicia tercer row-->
                            <div class="col-md-4 ">
                                <a href="<?php echo e(url('titulos')); ?>" class="btn btn-outline-info">Volver</a>
                            </div>      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unidad1\resources\views/titulo/consulta.blade.php ENDPATH**/ ?>