                    ...
                    <form action="<?php echo e(url('titulos/'.$row->id)); ?>" method="POST">
                        <div class="row"> <!--inicia primer row-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nombre" placeholder="captura el nombre del libro" value="<?php echo e($row->nombre); ?>" maxlength="40">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row"> <!--inicia tercer row-->
                            <div class="col-md-4 offset-md-8">
                                <input type="submit" name="Modificar" value="Modificar" class="btn btn-outline-success"><a href="<?php echo e(url('titulos')); ?>" class="btn btn-outline-danger">Cancelar</a>
                            </div>      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unidad1\resources\views/titulo/edit.blade.php ENDPATH**/ ?>