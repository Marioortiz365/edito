    ...
    <body>
        <header>
              <!--div class="col-md-12 text-right"-->
                <img src="<?php echo e(asset('images/upz.png')); ?>" align="right" width="200px">
            <!--/div-->

          <br>
          <br> 
          <!--  <?php echo $__env->yieldContent('title_report'); ?> -->
...
</html><?php /**PATH C:\xampp\htdocs\unidad1\resources\views/pdf/layout.blade.php ENDPATH**/ ?>