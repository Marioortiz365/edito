                    ...
                    <form action="<?php echo e(url('editoriales/'.$row->id)); ?>" method="POST">
                        ...
                        <div class="row"> <!--inicia tercer row-->
                            <div class="col-md-4 offset-md-8">
                                <input type="submit" name="Borrar" value="Borrar" class="btn btn-outline-success"><a href="<?php echo e(url('editoriales')); ?>" class="btn btn-outline-danger">Cancelar</a>
                            </div>      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unidad1\resources\views/editorial/delete.blade.php ENDPATH**/ ?>