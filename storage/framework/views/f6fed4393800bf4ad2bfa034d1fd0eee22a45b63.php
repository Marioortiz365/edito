...
<?php $__env->startSection('content'); ?>
	<div class="container">
            ...
            <div class="card border-info mb-3">
                <div class="card-body">
                    <form action="<?php echo e(url('autores')); ?>" method="POST">
                        ...
                        <div class="row"> <!--inicia tercer row-->
                            <div class="col-md-4 offset-md-8">
                                <input type="submit" name="Agregar" value="Agregar" class="btn btn-outline-success" method="POST"><a href="<?php echo e(url('autores')); ?>" class="btn btn-outline-danger">Cancelar</a>
                            </div>      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unidad1\resources\views/autor/create.blade.php ENDPATH**/ ?>